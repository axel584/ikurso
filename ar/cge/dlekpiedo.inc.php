...
<?
					if ($erarkodo=="1") {echo "<span class=\"eraro\">$lgv_eraro1</span>";}
					if ($erarkodo=="2") {echo "<span class=\"eraro\">$lgv_eraro2</span>";} 
					if ($erarkodo=="3") {echo "<span class=\"eraro\">$lgv_eraro3</span>";} 
					if ($erarkodo=="6") {echo "<span class=\"eraro\">$lgv_eraro6</span>";} 
					if ($erarkodo=="7") {echo "<span class=\"eraro\">$lgv_eraro7</span>";} 
					if ($erarkodo=="8") {echo "<span class=\"eraro\">$lgv_eraro8</span>";} 
