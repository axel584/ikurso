	...
	<div id="subpagxo">
		<div id="pagxmenuo">
			...
			<h2>Farbskatol&rsquo;</h2>
				...
				<img alt="jefo-logeto" src="<?=$vojo?>bildoj/logo_JEFO.gif" /></a><br />
				avec le soutien de 
				<a href="http://www.linguaforce.com/esperanto/traduction.htm" alt="linguaforce"><img src="<?=$vojo?>bildoj/linguaforce.gif" align="center" border="0"></a>
				</p>
		</div> <!-- pagxmenuo -->
