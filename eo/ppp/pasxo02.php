	...
	<article class="col s12 m10 l7 offset-m1 offset-l1">
		...
		?>
			<div class="rakonto">
				...
				<img class="flot-d l-50 s-50" src="bildoj/psalmaro.png"><p>Kion fari, mi iris aĉeti psalmaron.</p>
				...
				<img class="flot-d l-45 s-100" src="bildoj/knabino-spegulo.jpg"><p>Kun la malfermita psalmaro ŝi kantis falsvoĉe. De tempo al tempo ŝi rigardis al la spegulo, ĉu ŝia zono bone kuŝas? Kelkfoje ŝi ordigis sian harplekton, kelkfoje glatigis ĉifon sur la robo, kiu ne estis bonorde sur ŝia ŝultro.</p>
