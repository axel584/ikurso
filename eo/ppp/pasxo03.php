		...
		?>
			<div class="vortlisto row">
				<div class="col s12 m6">
					...
					<p><span class="eo">BARAKTI</span>: forte movi sin por liberigi de io.</p>
					<p><span class="eo">BASTONO</span>: longa, maldika peco de ligno.</p>
					<p><span class="eo">BLOVI</span>: ekmovi la aeron.</p>
					<p><span class="eo">BOLi</span>: varmigi je 100 gradoj centigradaj; forte malkvietigi.</p>
			...
			<div class="col s12 m6">
					...
					<p><span class="eo">PELT</span>: irigi rapide antaŭen.</p>
...
<p>Mi estis elirinta el la domo por iri al la deklivo apud la haveno, ĉar mi scias, ke ĉiuj vilaĝanoj estos tie — ne por helpi, ĉar helpo estus neebla en tia ventego kia ĉi tiu, kaj ne por trovi plezuron en la vidotaĵo, ĉar la vidaĵo estas korŝira, kiam homoj baraktas por savi la vivon kontraŭ furiozantaj elementoj, sed nur ĉar ill ne povus resti hejme, ĉar ili estus tirataj al la scenejo kvazaŭ de magneto.</p>
...
<p>“Ne”, li respondis, “sed ne estas kredeble, ke ĝi estu unu el niaj ŝipetoj. Ĉiuj niaj estis de la fiŝejo preter la insulo, kaj sendube ili ĉiuj rapidis al la insula haveno tuj kiam oni aŭdis la radian averton pri ventego antaŭ du horoj. Neniu el la ŝipestroj riskus reveni ĉi tien dum ventego.”</p>
...
<p>“Dio ne permesu, ke ili provu eniri ĉi tien,” subdiris maljunulo apudstaranta, “la sola”ŝanco estas preterveturi — iri laŭ la ventego ĝis ĝi forvelkas. Se ili provos eniri, la ondoj certe ĵetos ilin sur la rokojn ĉe la okcidenta promontoro, kaj la ŝpeto estos disfrakasita.”</p>
...
<p>Ni trovis iliajn kadavrojn en la sekvanta mateno, kiam forpasis la ŝtormo kaj la maro estis denove trankvila, kaj ni enterigis la kvin en unu tombon sub la ombro de la malnova preĝejo ĉe la supro de la havena deklivo, kiu alrigardas al la maro, sur kiu ili vivis kaj en kiu i1i mortis. Kune i1i dormas tie, kaj super ilia eterna restadejo aŭdiĝas la sovaĝa muĝado de la Norda Maro kaj la malgaja kriado de la mevoj.</p>
