...
?>
		<br />
		<input type="text" name="message" size="75" maxlength="<?php echo $chatbox_config['max_msg_len']; ?>" value="Enter Message" onFocus="clear_text()" <?php if (isset($chatbox_config['vietuni'])) echo " onkeyup='initTyper(this);'"; ?> class="editbox">
