			...
			<table width="100%" border="0" cellpadding="3" cellspacing="1" class="forumline">
				...
				<tr> 
						...
						<td valign="middle" align="center"> <br />
						  <table width="100%" border="0" cellspacing="0" cellpadding="5">
							...
							<tr align="center" valign="middle"> 
							  ...
							  <img src="{smilies_row.smilies_col.SMILEY_IMG}" border="0" alt="{smilies_row.smilies_col.SMILEY_DESC}" title="{smilies_row.smilies_col.SMILEY_DESC}" style="margin-top:5px;"/></a></td>
							  <!-- END smilies_col -->
							</tr>
							<!-- END smilies_row -->
				  ...
				  <td class="row2" valign="top"><span class="gen"> <span class="genmed"> </span> 
					<table width="450" border="0" cellspacing="0" cellpadding="2" style="margin-top:5px;">
					  <tr align="center" valign="middle"> 
					  ...
					  <tr> 
						<td colspan="9" style="margin-top:5px;"> <span class="gensmall"> 
