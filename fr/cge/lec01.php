...
<div class="row">
	<article class="col s12 m10 l7 offset-m1 offset-l1">
		...
		<section id="leciono-enhavo">
			...
			<a href="../son/l01.wav"><i class="material-icons">volume_up</i></a></p>
			
			<div class="vortlisto row">
				<p class="col s12 m6"><span class="eo">Viaj filoj estas niaj amikoj.</span></p>
				<p class="col s12 m6">Vos fils sont nos amis.</p>
				<p class="col s12 m6"><span class="eo">Iliaj kafoj estos varmaj.</span></p>
				<p class="col s12 m6">Leurs cafés seront chauds.</p>
				<p class="col s12 m6"><span class="eo">La knaboj estas grandaj.</span></p>
				<p class="col s12 m6">Les garçons sont grands.</p>
				<p class="col s12 m6"><span class="eo">Ŝia pano estis seka.</span></p>
				<p class="col s12 m6">Son pain (à elle) était sec.</p>
				<p class="col s12 m6"><span class="eo">Vi estas lia filo.</span></p>
				<p class="col s12 m6">Tu es son fils (à lui).</p>
				<p class="col s12 m6"><span class="eo">La instruisto estas sana.</span></p>
				<p class="col s12 m6">L'instituteur est en bonne santé.</p>
				<p class="col s12 m6"><span class="eo">Via amiko estas bela.</span></p>
				<p class="col s12 m6">Ton ami est beau.</p>
				<p class="col s12 m6"><span class="eo">La kuko estis lia.</span></p>
				<p class="col s12 m6">Le gâteau était à lui (était le sien)</p>
			</div>
