		...
		<div class="tasko" id="qcm">
			...
			<div class="row">
				...
				<p class="col s12 m6 l7">
					<input type="radio" name="qcm1" value="1" id="002-01" /><label for="002-01">La kafo estas varma</label><br>
					<input type="radio" name="qcm1" value="2" id="002-02" /><label for="002-02">La cafeo estas varma</label><br>
					<input type="radio" name="qcm1" value="3" id="002-03" /><label for="002-03">La kafo estas ĉauda</label><br>
				</p>
			</div>
		</div>
		
		<div class="row">
			<p class="col s12 m6 l7 offset-m6 offset-l5">
				<a id="kontroliQCM_button" class="waves-effect waves-light btn tooltipped light-blue darken-1" data-kurso="CG" data-leciono="2" data-lecionero_id="18" data-position="top" data-delay="50" data-tooltip="Vous pourrez corriger vos mauvaises réponses avant de passer à la suite" data-tooltip-id="bd165440-7a69-c1db-d97d-a50fd44998c4">Vérifier ma réponse</a>	
			</p>			
		</div>
