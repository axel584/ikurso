...
if (($parto=="ek")&&($numcxap!="01")){ ?>
		...
		<? } else {?>
			<p><strong><? echo $persono['enirnomo']; ?></strong>, &#265;u vi bone relegis vian taskon?
		...
		<? } ?>
			...
			<p><textarea name="kialo" rows="5" cols= "65"><? if (isset($memorkurso["kialo"])){echo  stripslashes($memorkurso["kialo"]);}?></textarea>
			</p>
