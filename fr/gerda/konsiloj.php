	...
	<div class="row">
		<article class="col s12 m10 l7 offset-m1 offset-l1">
			<section id="leciono-enhavo">
				...
				<h3>Kiuj vi estas?</h3>
				<p>
				  Plejparte tiuj, kiuj finis la kurson <i>Gerda malaperis</i>, antaŭe finis la
				  kurson <i>DLEK (Dek Leciona Kurso)</i> aŭ <i>Kurso de Esperanto</i>. </p>

				<a id="kiel" class="scrollspy"></a>
				<h3>Kiel lerni plu?</h3>
				<p>Vi jam havas bonan nivelon en la lingvo. Tion ĉi atestas via
				  kapablo legi senprobleme ĉi tiun teksteton (la vortoj, kiuj ne
				  troviĝas en <i>Gerda malaperis</i>, ricevas tradukon fine de tiu ĉi paĝo).
				  ...
				  pliajn. Kiel do lerni plu ?</p>
				
				<p class="parto">
				  <b>Unua konsilo</b>: <b>parolu!</b> Unuhora babilado kun kompetentaj
				...
				<ul>
					<li>Unue, sciu, ke multaj Esperanto-asocioj okazigas regulajn
				...
				<ul class="klarigo">
					...
					<li><i>Grand dictionnaire français-espéranto</i>, eldonita de Espéranto-France.
				...
				<ul class="klarigo">
					...
					<li><i>La kisa malsano</i></li>
					<li><i>Ĉu ili venis trakosme?</i></li>
					<li><i>Ĉu vi kuiras ĉine?</i></li>
					<li>kaj multaj aliaj…</li>
				</ul>
	
				<a id="movado" class="scrollspy"></a>
				<h3>La E-a movado: kio kaj kia ĝi estas?</h3>
				...
				<a id="konkludo" class="scrollspy"></a>
				<h3>Konkludo: aliĝu!</h3>
				...
				<li class="active">
					...
					<div class="collapsible-body">
						<ul id="enhavtabelo" class="collection">
							...
							<li><a href="#aliajkonsiloj">Ankaŭ konsilindaj por studemuloj</a></li>
