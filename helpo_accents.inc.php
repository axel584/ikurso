				  	<h2>Les lettres accentuées</h2>
				  	
			  			  	
				  	<h3 id="methodes">Les différentes méthodes pour représenter les accents</h3>
				  	<p>
					...
					<em>Dua libro</em>, une de ses premières brochures.<br>
				  	</p>
					...
					quelques-uns parmi les plus répandus.</p>
					
					<h4>Clavier français-espéranto pour Windows</h4>
				
					<p class="noto">Le contenu de cette page provient du site <a href="http://ttt.jubilo.ca/ttt/clavier/">
					...
					<h4>Clavier diacrité pour Windows</h4>
				  	...
				  	<p>Cet outil est proposé par Michael Langlois. Le <em>clavier diacrité</em> permet de taper directement
					...
					<p>Informations et téléchargement sur <a href="http://www.esperanto.mv.ru/Ek/index.html" class="btn-flat small blue-text"><i class="material-icons right">arrow_right</i>www.esperanto.mv.ru/Ek</a>

					<h4>Unired</h4>
							<li> est un éditeur de 
							texte qui prend en compte les différentes lettres accentuées.</p> 
							<p>Informations et téléchargement sur <a href="http://www.framasoft.net/article.php3?id_article=2798" class="btn-flat small blue-text"><i class="material-icons right">arrow_right</i>Unired</a>
				  	</p>
