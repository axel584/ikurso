			...
			<div id="kadro">
				...
				<?php if ($temo=="inscription") { ?>
					...
					<?php if ($temo=="utilisation") { ?>
						...
						-	sans la zone de l’adresse, modifiez la valeur https://ikurso.esperanto-france.org 
						par https://ikurso.esperanto-france.org/eniri.php?enirnomo=identifiant&pasvorto=mot_de_passe   
