...
CREATE TABLE ekzerceroj ( `id` INT NOT NULL AUTO_INCREMENT ,`ekzerco_id` int(11) NOT NULL, `kodo` VARCHAR(10) NOT NULL , `demando` TEXT NOT NULL ,`respondo` text NOT NULL, `bildo` VARCHAR(64) NOT NULL ,`forigita` BOOLEAN NOT NULL DEFAULT  '0',`korektebla` BOOLEAN NOT NULL DEFAULT  '0', PRIMARY KEY (`id`)) ENGINE = InnoDB;
