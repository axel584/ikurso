...
insert into ekzerceroj (id,ekzerco_id,kodo,numero,demando,respondo,normaligita,bildo,forigita) values (299,52,'ekz_02_01',1,'Linda estas ___. (malserioza / nova studento / bela kaj pala / io stranga)','Linda estas <b>bela kaj pala</b>.','linda estas bela kaj pala|bela kaj pala','',0);
insert into ekzerceroj (id,ekzerco_id,kodo,numero,demando,respondo,normaligita,bildo,forigita) values (300,52,'ekz_02_02',2,'Kio okazas? (Linda rigardas al la spegulo. / Malalta viro staras inter Tom kaj la pordo. / La blonda viro agas strange. / La nova studento proksimiĝas al Tom.)','<b>La blonda viro</b> agas strange.','la blonda viro agas strange','',0);
insert into ekzerceroj (id,ekzerco_id,kodo,numero,demando,respondo,normaligita,bildo,forigita) values (301,52,'ekz_02_03',3,'Ĉu estas io en lia mano? (jes / ne)','<b>Jes</b>, estas io en lia mano.','jes|jes estas io en lia mano|jes io estas en lia mano','',0);
insert into ekzerceroj (id,ekzerco_id,kodo,numero,demando,respondo,normaligita,bildo,forigita) values (302,52,'ekz_02_04',4,'Al kio montras la mistera ulo? (al la spegulo / al la pordo / al Linda / al Tom / al la angulo)','La mistera ulo montras <b>al la pordo</b>.','al la pordo|li montras al la pordo|la mistera ulo montras al la pordo','',0);
insert into ekzerceroj (id,ekzerco_id,kodo,numero,demando,respondo,normaligita,bildo,forigita) values (303,52,'ekz_02_05',5,'Al kio rigardas la juna knabino, kiu estas kun li? (al la spegulo / al la pordo / al Linda / al Tom / al la angulo)','La juna knabino rigardas <b>al la pordo</b>.','al la pordo|sxi rigardas al la pordo|la juna knabino rigardas al la pordo','',0);
insert into ekzerceroj (id,ekzerco_id,kodo,numero,demando,respondo,normaligita,bildo,forigita) values (304,52,'ekz_02_06',6,'Ĉu nun estas io en la taso? (jes / ne)','<b>Jes</b>, nun estas io en la taso.','jes|jes nun estas io en la taso|jes io estas nun en la taso','',0);
insert into ekzerceroj (id,ekzerco_id,kodo,numero,demando,respondo,normaligita,bildo,forigita) values (305,53,'ekz_02_07',7,'Mi ne vidas, [ĉu/se] la junulo parolas al la knabino, aŭ [ĉu/se] li nur rigardas al ŝi.','Mi ne vidas, <b>ĉu</b> la junulo parolas al la knabino, aŭ <b>ĉu</b> li nur rigardas al ŝi.','mi ne vidas cxu la junulo parolas al la knabino aux cxu li nur rigardas al sxi','',0);
insert into ekzerceroj (id,ekzerco_id,kodo,numero,demando,respondo,normaligita,bildo,forigita) values (306,53,'ekz_02_08',8,'Vi vidas lin tute bone, [ĉu /se] ne?','Vi vidas lin tute bone, <b>ĉu</b> ne?','vi vidas lin tute bone cxu ne','',0);
insert into ekzerceroj (id,ekzerco_id,kodo,numero,demando,respondo,normaligita,bildo,forigita) values (307,53,'ekz_02_09',9,'[Ĉu/Se] li agas strange, li estas strangulo.','<b>Se</b> li agas strange, li estas strangulo.','se li agas strange li estas strangulo','',0);
